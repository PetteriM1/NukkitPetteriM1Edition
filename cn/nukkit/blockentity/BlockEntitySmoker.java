...
public class BlockEntitySmoker
extends BlockEntityFurnace {
    ...
    public boolean onUpdate() {
        ...
        int n = item2.getId();
        if (n != 319 && n != 363 && n != 411 && n != 349 && n != 365 && n != 423 && n != 460 && n != 392) {
            return true;
        }
        ...
        if (this.burnTime > 0) {
            ...
            if (this.getBlock().getId() == 454) {
                this.getLevel().setBlock(this, Block.get(453, this.getBlock().getDamage()), true);
            }
            this.burnTime = 0;
            this.cookTime = 0;
            this.burnDuration = 0;
    ...
    public CompoundTag getSpawnCompound() {
        CompoundTag compoundTag = new CompoundTag().putString("id", "Smoker").putInt("x", (int)this.x).putInt("y", (int)this.y).putInt("z", (int)this.z).putShort("BurnDuration", this.burnDuration).putShort("BurnTime", this.burnTime).putShort("CookTime", this.cookTime);
        if (this.hasName()) {
