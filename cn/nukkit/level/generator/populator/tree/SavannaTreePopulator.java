...
extends Populator {
    ...
    public SavannaTreePopulator(int n) {
    }
    ...
    public void populate(ChunkManager chunkManager, int n, int n2, NukkitRandom nukkitRandom, FullChunk fullChunk) {
        this.a = chunkManager;
        int n3 = nukkitRandom.nextBoundedInt(this.b + 1) + this.c;
        ...
        for (int k = 0; k < n3; ++k) {
            ...
            if (n6 == -1) continue;
            new ObjectSavannaTree().generate(chunkManager, nukkitRandom, vector3.setComponents(n5, n6, n4));
        }
    }
