...
public class LevelSoundEventPacket
extends DataPacket {
    public static final byte NETWORK_ID = 123;
    ...
    public String toString() {
        return "LevelSoundEventPacket(sound=" + this.sound + ", x=" + this.x + ", y=" + this.y + ", z=" + this.z + ", extraData=" + this.extraData + ", entityIdentifier=" + this.entityIdentifier + ", isBabyMob=" + this.isBabyMob + ", isGlobal=" + this.isGlobal + ")";
    }
}
