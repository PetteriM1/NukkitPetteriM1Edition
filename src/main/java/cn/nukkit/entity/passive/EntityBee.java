    ...
    public Vector3 updateMove(int tickDiff) {
        ...
        if (!this.isImmobile()) {
            ...
            if (this.followTarget != null && !this.followTarget.closed && this.followTarget.isAlive() && this.followTarget.canBeFollowed()) {
                ...
                if (this.riding != null || diff == 0 || this.stayTime > 0 || this.distance(this.followTarget) <= (this.getWidth() / 2 + 1)) {
                    this.motionX = 0;
                    this.motionZ = 0;
                    if (this.riding == null) {
            ...
            if (this.followBlock != null) {
                ...
                double diff = Math.abs(x) + Math.abs(z);
                if (this.riding != null || diff == 0 || this.stayTime > 0 || this.distance(this.followBlock) <= (this.getWidth() / 2 + 1)) {
                    this.motionX = 0;
                    this.motionZ = 0;
                    if (this.riding != null) {
                        this.motionY = this.getVerticalSpeed(0.01, y);
            ...
            if (this.target instanceof EntityCreature || !this.isLookupForTarget() || before != this.target) {
                ...
                double diff = Math.abs(x) + Math.abs(z);
                double nDist;
                if (this.riding != null || diff == 0 || this.stayTime > 0 || this.distance(this.target) <= (nDist = ((this.getWidth() / 2 + 1) * nearbyDistanceMultiplier())) * nDist) {
                    this.motionX = 0;
                    this.motionZ = 0;
                    if (this.riding == null) {
                        this.motionY = this.getVerticalSpeed(0.01, y);
