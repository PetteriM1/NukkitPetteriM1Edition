...
public class PlayerOffhandInventory extends BaseInventory {
     ...
     */
    private static final List<Integer> OFFHAND_ITEMS = Arrays.asList(ItemID.SHIELD, ItemID.ARROW, ItemID.TOTEM, ItemID.MAP, ItemID.FIREWORKS, ItemID.NAUTILUS_SHELL, ItemID.SPARKLER);
