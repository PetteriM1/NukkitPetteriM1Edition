...
public class CustomItemManager {
    ...
    private BatchPacket cachedPacket2192;
    ...
    public BatchPacket getCachedPacket(int protocol) {
        ...
        if (protocol >= ProtocolInfo.v1_26_50_27) {
            if (this.cachedPacket2192 == null) {
                this.cachedPacket2192 = createPacket(ProtocolInfo.v1_26_50_27);
            }
            return this.cachedPacket2192;
