...
public class GlobalBlockPalette {
    ...
    public static int getOrCreateRuntimeId(int protocol, int legacyId) throws NoSuchElementException {
        ...
        legacyId = (short) (((legacyId >> Block.DATA_BITS) << 4) + Math.min((legacyId & Block.DATA_MASK), 15));
    ...
    public static void init() {
        ...
        // allocators
        AtomicInteger runtimeIdAllocator282 = new AtomicInteger(0);
        AtomicInteger runtimeIdAllocator291 = new AtomicInteger(0);
        AtomicInteger runtimeIdAllocator313 = new AtomicInteger(0);
        AtomicInteger runtimeIdAllocator332 = new AtomicInteger(0);
        AtomicInteger runtimeIdAllocator340 = new AtomicInteger(0);
        AtomicInteger runtimeIdAllocator354 = new AtomicInteger(0);
        AtomicInteger runtimeIdAllocator361 = new AtomicInteger(0);
        ...
        if (Server.getInstance().getPropertyBoolean("legacy-protocol-support", false)) {
            Gson GSON = new Gson();
            // 223
            ...
            Collection<TableEntryOld> entries223 = GSON.fromJson(new InputStreamReader(stream223, StandardCharsets.UTF_8), new TableEntryOldCollectionTypeToken());
            ...
            Collection<TableEntryOld> entries261 = GSON.fromJson(new InputStreamReader(stream261, StandardCharsets.UTF_8), new TableEntryOldCollectionTypeToken());
            ...
            Collection<TableEntryOld> entries274 = GSON.fromJson(new InputStreamReader(stream274, StandardCharsets.UTF_8), new TableEntryOldCollectionTypeToken());
            ...
            Collection<TableEntry> entries282 = GSON.fromJson(new InputStreamReader(stream282, StandardCharsets.UTF_8), new TableEntryCollectionTypeToken());
            ...
            Collection<TableEntry> entries291 = GSON.fromJson(new InputStreamReader(stream291, StandardCharsets.UTF_8), new TableEntryCollectionTypeToken());
            ...
            Collection<TableEntry> entries313 = GSON.fromJson(new InputStreamReader(stream313, StandardCharsets.UTF_8), new TableEntryCollectionTypeToken());
            ...
            Collection<TableEntry> entries332 = GSON.fromJson(new InputStreamReader(stream332, StandardCharsets.UTF_8), new TableEntryCollectionTypeToken());
            ...
            Collection<TableEntry> entries340 = GSON.fromJson(new InputStreamReader(stream340, StandardCharsets.UTF_8), new TableEntryCollectionTypeToken());
            ...
            Collection<TableEntry> entries354 = GSON.fromJson(new InputStreamReader(stream354, StandardCharsets.UTF_8), new TableEntryCollectionTypeToken());
            ...
            Collection<TableEntry> entries361 = GSON.fromJson(new InputStreamReader(stream361, StandardCharsets.UTF_8), new TableEntryCollectionTypeToken());
