...
public class PlayerAuthInputPacket extends DataPacket {
    ...
    public void decode() {
        ...
        } else if (protocol >= ProtocolInfo.v1_26_50_27 || this.getBoolean()) {
        ...
        if (protocol >= ProtocolInfo.v1_26_40 && this.getBoolean() && (protocol >= ProtocolInfo.v1_26_50_27 || this.getBoolean())) {
        ...
        if ((protocol >= ProtocolInfo.v1_26_40 && this.getBoolean() && (protocol >= ProtocolInfo.v1_26_50_27 || this.getBoolean())) ||
                (protocol < ProtocolInfo.v1_26_40 && this.inputData.contains(AuthInputAction.PERFORM_BLOCK_ACTIONS))) {
        ...
        if (protocol >= ProtocolInfo.v1_26_40) {
            if (this.getBoolean() && (protocol >= ProtocolInfo.v1_26_50_27 || this.getBoolean())) {
