...
public class StartGamePacket extends DataPacket {
    ...
    // PM1E only
    public boolean eduMode; // pre 388
    public boolean broadcastToXboxLive = true; // pre 332
    public int gamePublish = 4; // pre 332
    public boolean broadcastToPlatform; // pre 332
    public int platformBroadcastMode = 4; // pre 332
    public boolean xblBroadcastIntentOld = true; // pre 332
    public boolean trustingPlayers; // pre 332
