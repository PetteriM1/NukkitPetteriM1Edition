...
public class StartGamePacket extends DataPacket {
    ...
    static {
        try {
            ...
            try (Reader reader = new InputStreamReader(Objects.requireNonNull(StartGamePacket.class.getClassLoader().getResourceAsStream("block_properties_2192.json")), StandardCharsets.UTF_8)) {
                Type type = new TypeToken<List<BlockPropertyData>>() {
                }.getType();
