...
public abstract class DefaultPermissions {
    ...
    public static void registerCorePermissions() {
        ...
        registerPermission(new Permission(ROOT + ".command.transferserver", "Allows the user to transfer to other server", Permission.DEFAULT_TRUE), commands);
        ...
        registerPermission(new Permission(ROOT + ".command.gamerule", "Allows the user to change game rules", Permission.DEFAULT_OP), commands);
        registerPermission(new Permission(ROOT + ".command.spawn", "Allows the user to use spawn command", Permission.DEFAULT_TRUE), commands);
