...
public class RakNetServerSession extends RakNetSession {
    ...
    void sendOpenConnectionReply1() {
        if (++sentConnection1Replies > 10) {
            if (sentConnection1Replies == 11) {
    ...
    private void sendOpenConnectionReply2() {
        if (++sentConnection2Replies > 10) {
            if (sentConnection2Replies == 11) {
    ...
    private void sendConnectionRequestAccepted(long time) {
        if (++sentConnectionAcceptedReplies > 10) {
            if (sentConnectionAcceptedReplies == 11) {
