...
import org.iq80.oldleveldb.Snapshot;
import org.iq80.oldleveldb.impl.Filename.FileInfo;
import org.iq80.oldleveldb.impl.Filename.FileType;
import org.iq80.oldleveldb.impl.MemTable.MemTableIterator;
import org.iq80.oldleveldb.impl.WriteBatchImpl.Handler;
import org.iq80.oldleveldb.table.BytewiseComparator;
import org.iq80.oldleveldb.table.CustomUserComparator;
import org.iq80.oldleveldb.table.TableBuilder;
...
import static org.iq80.oldleveldb.util.Slices.readLengthPrefixedBytes;
import static org.iq80.oldleveldb.util.Slices.writeLengthPrefixedBytes;
...
public class DbImpl
    ...
    public DbImpl(Options options, File databaseDir)
        ...
        ThreadFactory compactionThreadFactory = new ThreadFactoryBuilder()
                ...
                .setUncaughtExceptionHandler((t, e) -> {
                    MainLogger.getLogger().error("On thread " + t, e);
                })
                .build();
        ...
        tableCache = new TableCache(databaseDir, tableCacheSize, new InternalUserComparator(internalKeyComparator), false);
    ...
    public void delete(byte[] key)
            throws DBException {
        writeInternal(new WriteBatchImpl().delete(key), Defaults.DEFAULT_WRITE_OPTIONS);
    }
...
//                Log(options_.info_log, "waiting...\n");
    ...
    private void openCompactionOutputFile(CompactionState compactionState)
        ...
        Preconditions.checkNotNull(compactionState);
        Preconditions.checkArgument(compactionState.builder == null);
