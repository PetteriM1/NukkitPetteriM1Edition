...
import org.iq80.oldleveldb.util.LevelIterator;
...
public class Level
    ...
    public Level(int levelNumber, List<FileMetaData> files, TableCache tableCache, InternalKeyComparator internalKeyComparator) {
        Preconditions.checkArgument(levelNumber >= 0);
    ...
    public LookupResult get(LookupKey key, ReadStats readStats) {
        ...
        for (FileMetaData fileMetaData : fileMetaDataList) {
            ...
            if (iterator.hasNext()) {
                ...
                if (internalKey == null) throw new IllegalStateException("Corrupt key for " + key.getUserKey().toString(UTF_8));
