...
import static org.iq80.oldleveldb.impl.LogConstants.BLOCK_SIZE;
import static org.iq80.oldleveldb.impl.LogConstants.HEADER_SIZE;
import static org.iq80.oldleveldb.impl.Logs.getChunkChecksum;
...
public class MMapLogWriter
    ...
    private void writeChunk(LogChunkType type, Slice slice)
            throws IOException {
        Preconditions.checkArgument(slice.length() <= 0xffff);
