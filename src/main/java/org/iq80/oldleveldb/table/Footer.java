...
import static org.iq80.oldleveldb.table.BlockHandle.readBlockHandle;
import static org.iq80.oldleveldb.table.BlockHandle.writeBlockHandleTo;
...
public class Footer {
    ...
    public static Footer readFooter(Slice slice) {
        ...
        Preconditions.checkArgument(slice.length() == ENCODED_LENGTH);
        ...
        Preconditions.checkArgument(magicNumber == TableBuilder.TABLE_MAGIC_NUMBER);
